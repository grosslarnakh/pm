...
angular.module('core').controller('RootController', ['$scope', '$rootScope', '$modal', '$filter', '$interval', 'WeeksProvider', 'Payment', function($scope, $rootScope, $modal, $filter, $interval, WeeksProvider, Payment) {
    $rootScope.payments = [];
